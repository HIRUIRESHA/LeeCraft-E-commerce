...
@Component({
    ...
    @if (adminAuth.isAuthenticated()) {
      ...
      >
        ...
        <div class="sidebar-header">
          <a class="sidebar-brand" [href]="storefrontUrl" target="_blank" rel="noopener">
            <div class="logo-box">
              <img src="/assets/images/logo.png" alt="LeeCraft" class="brand-logo" />
            </div>
            @if (!ui.isSidebarCollapsed()) {
              <div class="brand-text">
                <span class="brand-name serif">LeeCraft<span class="accent">.lk</span></span>
        ...
        <div class="sidebar-footer">
          ...
          <div class="admin-user-card" [class.compact]="ui.isSidebarCollapsed()">
            <div class="user-avatar" [title]="adminAuth.admin()?.fullName || 'Admin'">
              {{ adminInitials() }}
            </div>
            @if (!ui.isSidebarCollapsed()) {
              <div class="user-info">
                <span class="user-name">{{ adminAuth.admin()?.fullName || 'Administrator' }}</span>
      ...
      <header class="top-navbar" [class.sidebar-collapsed]="ui.isSidebarCollapsed()">
  ...
  styles: [`
    ...
    .admin-sidebar {
      ...
      bottom: 0;
      width: 260px;
      background: linear-gradient(180deg, #1C1510 0%, #221A14 60%, #17110C 100%);
      color: #E6D8C8;
      z-index: 1050;
      display: flex;
    ...
    .nav-link.active {
      background: linear-gradient(90deg, rgba(194, 129, 72, 0.24) 0%, rgba(138, 75, 46, 0.14) 100%);
      color: #FFF;
      font-weight: 600;
    ...
    .user-avatar {
      ...
      height: 34px;
      border-radius: 50%;
      background: linear-gradient(135deg, var(--wood-500, #8A4B2E), var(--wood-400, #A9764F));
      color: #FFF;
      font-size: 12.5px;
      font-weight: 700;
